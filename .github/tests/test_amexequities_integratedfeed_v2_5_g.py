...
SCHEMA = "nyse/amexequities/integratedfeed/AmexEquities_IntegratedFeed_v2_5_g.dfdl.xsd"
PARSER = os.path.join(os.environ.get("RUNNER_TEMP", "/tmp"), "amexequities_integratedfeed_v2_5_g.parser")
DAFFODIL = os.environ.get("DAFFODIL", "daffodil")


class AmexequitiesIntegratedfeedV25GTests(unittest.TestCase):
