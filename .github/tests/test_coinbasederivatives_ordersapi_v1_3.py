...
SCHEMA = "coinbase/coinbasederivatives/ordersapi/CoinbaseDerivatives_OrdersApi_v1_3.dfdl.xsd"
PARSER = os.path.join(os.environ.get("RUNNER_TEMP", "/tmp"), "coinbasederivatives_ordersapi_v1_3.parser")
