...
SCHEMA = "iex/iexequities/deepplus/IexEquities_DeepPlus_v1_01.dfdl.xsd"
PARSER = os.path.join(os.environ.get("RUNNER_TEMP", "/tmp"), "iexequities_deepplus_v1_01.parser")
