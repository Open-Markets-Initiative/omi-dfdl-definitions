...
SCHEMA = "tmx/tsx/quantumfeedlevel2/Tsx_QuantumFeedLevel2_v2_1.dfdl.xsd"
PARSER = os.path.join(os.environ.get("RUNNER_TEMP", "/tmp"), "tsx_quantumfeedlevel2_v2_1.parser")
