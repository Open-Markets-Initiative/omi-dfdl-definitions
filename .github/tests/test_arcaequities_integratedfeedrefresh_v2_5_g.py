...
SCHEMA = "nyse/arcaequities/integratedfeedrefresh/ArcaEquities_IntegratedFeedRefresh_v2_5_g.dfdl.xsd"
PARSER = os.path.join(os.environ.get("RUNNER_TEMP", "/tmp"), "arcaequities_integratedfeedrefresh_v2_5_g.parser")
DAFFODIL = os.environ.get("DAFFODIL", "daffodil")


class ArcaequitiesIntegratedfeedrefreshV25GTests(unittest.TestCase):
