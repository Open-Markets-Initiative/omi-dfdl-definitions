...
SCHEMA = "nyse/nyseequities/integratedfeed/NyseEquities_IntegratedFeed_v2_3_a.dfdl.xsd"
PARSER = os.path.join(os.environ.get("RUNNER_TEMP", "/tmp"), "nyseequities_integratedfeed_v2_3_a.parser")
