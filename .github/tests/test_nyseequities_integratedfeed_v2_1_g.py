...
SCHEMA = "nyse/nyseequities/integratedfeed/NyseEquities_IntegratedFeed_v2_1_g.dfdl.xsd"
PARSER = os.path.join(os.environ.get("RUNNER_TEMP", "/tmp"), "nyseequities_integratedfeed_v2_1_g.parser")
