...
SCHEMA = "cboe/titaniumconsolidated/indices/Cboe_TitaniumConsolidated_Indices_v1_4_13.dfdl.xsd"
PARSER = os.path.join(os.environ.get("RUNNER_TEMP", "/tmp"), "cboe_titaniumconsolidated_indices_v1_4_13.parser")
DAFFODIL = os.environ.get("DAFFODIL", "daffodil")


class CboeTitaniumconsolidatedIndicesV1413Tests(unittest.TestCase):
