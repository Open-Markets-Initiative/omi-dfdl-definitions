...
SCHEMA = "nyse/texasequities/integratedfeedrefresh/TexasEquities_IntegratedFeedRefresh_v2_5_g.dfdl.xsd"
PARSER = os.path.join(os.environ.get("RUNNER_TEMP", "/tmp"), "texasequities_integratedfeedrefresh_v2_5_g.parser")
