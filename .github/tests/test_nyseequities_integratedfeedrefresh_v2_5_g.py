...
SCHEMA = "nyse/nyseequities/integratedfeedrefresh/NyseEquities_IntegratedFeedRefresh_v2_5_g.dfdl.xsd"
PARSER = os.path.join(os.environ.get("RUNNER_TEMP", "/tmp"), "nyseequities_integratedfeedrefresh_v2_5_g.parser")
DAFFODIL = os.environ.get("DAFFODIL", "daffodil")


class NyseequitiesIntegratedfeedrefreshV25GTests(unittest.TestCase):
