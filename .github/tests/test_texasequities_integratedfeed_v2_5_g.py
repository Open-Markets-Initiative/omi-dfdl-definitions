...
SCHEMA = "nyse/texasequities/integratedfeed/TexasEquities_IntegratedFeed_v2_5_g.dfdl.xsd"
PARSER = os.path.join(os.environ.get("RUNNER_TEMP", "/tmp"), "texasequities_integratedfeed_v2_5_g.parser")
